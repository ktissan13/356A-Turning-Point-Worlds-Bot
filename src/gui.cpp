...
static lv_res_t btnm_action(lv_obj_t * btnm, const char *txt) {
  ...
  case 1:
    auton_sel = 1;
    if(mirror == true){
    lv_label_set_text(g_sb_label, "Blue Front 10P Big Boi");
    }
    else{
    lv_label_set_text(g_sb_label, "Red Front 10P Big Boi");
    }
    break;
  case 2:
    auton_sel = 2;
    if(mirror == true){
    lv_label_set_text(g_sb_label, "Blue Back Stack Defensive Boi");
    }
    else{
    lv_label_set_text(g_sb_label, "Red Back Stack Defensive Boi");
    }
    break;
  case 3:
    if(mirror == true){
    lv_label_set_text(g_sb_label, "Blue Front Yeet");
    }
    else{
    lv_label_set_text(g_sb_label, "Red Front Yeet");
    }
    auton_sel = 3;
break;
  case 4:
...
void gui_3btn(void) {
 ...
 lv_label_set_text(label, "Skills 1");
...
// select demo
  ...
  lv_label_set_text(label, "Wagwan Tissan and Yahya");
  lv_obj_align(label, NULL, LV_ALIGN_IN_TOP_MID, 0, 5);
